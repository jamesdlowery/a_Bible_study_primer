...
the published texts of all 27 tracked translations: none does, including a specific direct
check against Young's Literal Translation, the ASV, the RSV, Webster's Bible, the World
English Bible, and the Douay-Rheims Bible, all of which render the phrase literally and
non-euphemistically, consistent with the original ten. The remaining entries are internal
...
- [Law and Custom](#law-and-custom)
- [Chronology and Genealogy](#chronology-and-genealogy)
- [Theological Tensions](#theological-tensions)
- [Narrative Propriety and Ethics](#narrative-propriety-and-ethics)
- [Chronology and Setting](#chronology-and-setting)
...
**How the translations render it:** All 27 tracked translations render both passages plainly and consistently as given, including Ruth 4:7's own explanatory aside about the custom; the harmonization concerns recognizing related but distinguishable applications of a broader redemption principle, not translation choice.

**Reconciliation:** Most commentators note several real differences between the two customs. Boaz is a more distant relative, not Ruth's actual brother-in-law as Deuteronomy 25's law specifically addresses. The redemption in Ruth 4 is framed primarily around land, per the go'el/kinsman-redeemer provisions of Leviticus 25:25, with the marriage to Ruth added as a further condition Boaz himself proposes (4:5). And the sandal removal in Ruth is performed by the declining kinsman himself, amicably, with no spitting or public shaming pronounced. Most commentators read Ruth 4:7's own explanatory aside -- 'now this was the custom in former times in Israel concerning redeeming and exchanging: to confirm a transaction, a man drew off his sandal and gave it to the other' -- as the author's acknowledgment that this was a broader, related legal-transfer custom. It likely developed from, or represents a variant local application of, the same underlying levirate and redemption principles found in Deuteronomy 25 and Leviticus 25, adapted here to a somewhat different specific situation (redemption by a non-brother relative) than Deuteronomy 25:5-10's narrower scenario. On this reading, the two passages describe related but distinct customs, not two flatly conflicting descriptions of a single, fixed legal procedure.
...
**The claim:** In Ruth 4, Boaz raises the matter of redeeming Naomi's land (invoking the kinsman-redeemer provisions of Leviticus 25:25, concerning a poor relative's property) together with an obligation to marry Ruth so as to 'raise up the name of the dead in his inheritance' (4:5, language echoing Deuteronomy 25's levirate marriage purpose) -- yet no single provision in the Law explicitly combines land-redemption and widow-marriage into one linked transaction of the kind Boaz describes, and the nearer kinsman's own response ('I cannot redeem it for myself, lest I impair my own inheritance,' 4:6) suggests the marriage obligation adds unexpected complications the land-redemption law alone would not create.

**How the translations render it:** All 27 tracked translations render Ruth 4:3-6 plainly and consistently as given; the harmonization concerns understanding ancient legal practice as an application of combined principles rather than a citation of one explicit combined law, not translation choice.

**Reconciliation:** Most commentators read Boaz's proposal in Ruth 4 not as a citation of a single, pre-existing statute that combines both provisions, but as a socially and legally reasonable extension and combination of two related principles already present in the Law -- caring for a poor, landless kinsman's family and property (Leviticus 25) and preserving a deceased man's family name and inheritance line (Deuteronomy 25) -- applied together to the specific, somewhat unusual situation of two widowed women with no surviving male heir and land at risk of permanent loss from the family line. Ancient Israelite law, like most ancient legal systems, did not anticipate or legislate for every possible combination of circumstances in explicit statutory form; narrative texts like Ruth are widely understood by legal historians to preserve evidence of how communities applied and combined the Law's underlying principles in practice, in situations the wording of any single provision does not by itself fully anticipate, rather than requiring that every combined application be traceable to one explicit combined statute.
...
**Reconciliation:** Naomi's statement is universally read by commentators as the anguished, first-person speech of a grieving widow processing severe personal loss within Israel's own theological framework of divine sovereignty over all events (a framework Job's speeches likewise reflect at length, e.g. Job 1:21, 'the LORD gave, and the LORD has taken away'), not as an inspired doctrinal statement the book's narrator endorses as a complete or final theological verdict. The book of Ruth as a whole is widely read as gently correcting or complicating Naomi's own bleak self-assessment through its unfolding plot: the God Naomi describes as having 'afflicted' and emptied her (1:21) is, by the book's end, shown providentially at work through Ruth's loyalty and Boaz's kindness to fill Naomi's life again (4:14-17, where the women explicitly bless the LORD for providing a redeemer), suggesting the narrative's own perspective is considerably more hopeful than Naomi's raw lament captures in the moment -- a distinction, common throughout Scripture's poetic and lament literature, between an inspired record of what a grieving person said and an endorsement of that statement as complete theological doctrine.
...
**The claim:** Ruth's often-quoted declaration -- 'where you go I will go... your people shall be my people, and your God my God' (1:16) -- is sometimes read as evidence of a full, deliberate religious conversion to the worship of Israel's God specifically, and at other times read primarily as an expression of personal loyalty and love toward Naomi that includes, almost incidentally, an acceptance of Naomi's people and God as part of the same undivided commitment -- a distinction some argue affects how her later inclusion in Israel (entry 1 above) should be understood theologically.

**How the translations render it:** All 27 tracked translations render Ruth 1:16-17 and 2:12 plainly and consistently as given; the question addressed here is one of emphasis in a single interconnected passage, not a matter of translation choice.

**Reconciliation:** This is not a contradiction between two texts but a question of emphasis in reading a single passage, and commentators reasonably differ on how sharply personal loyalty and religious commitment can or should be separated in Ruth's statement. Most note that the two are not presented in the text as competing categories: ancient near-eastern identity was rarely divided cleanly into 'personal relationship' versus 'religious commitment' as modern readers might distinguish them, and Ruth's own oath ('may the LORD do so to me and more also if anything but death parts me from you,' 1:17) explicitly invokes the LORD by his covenant name as the one who will enforce her vow -- an act of genuine religious commitment embedded within, and inseparable from, her personal loyalty to Naomi. The book elsewhere treats her allegiance to Israel's God as real and complete (Boaz commends her for having come 'to take refuge under [the LORD's] wings,' 2:12), which most interpreters take as settling the question in favor of reading her declaration as sincere religious commitment and not merely personal sentiment, whatever the precise weighting of the two elements in her own mind at the moment she spoke.

---

---

## Narrative Propriety and Ethics
...
**How the translations render it:** All 27 tracked translations render 'uncover his feet' literally and consistently, without euphemistic softening or explicit sexualizing in the wording itself -- confirmed directly for the Douay-Rheims Bible ("lift up the clothes wherewith he is covered towards his feet," a slightly fuller but equally literal, non-euphemistic rendering), the RSV, Young's Literal Translation, the American Standard Version, the World English Bible, and Webster's Bible, all of which render the phrase in the same literal, non-euphemistic manner as the original ten. **The CPDV** would be expected to follow Douay-Rheims' phrasing here, given its general reliance on that translation, though not separately confirmed. The interpretive question addressed here concerns the scene's meaning and cultural context, not any difference in how the translations render the Hebrew.
...
**The claim:** Ruth 1:1 sets the story broadly 'in the days when the judges ruled,' without naming a specific judge or a more precise date, leaving open which portion of the roughly 300-400-year judges period the events belong to -- a question with some bearing on how much of a stretch the genealogical-compression question (entry 4 above) actually represents.

**How the translations render it:** All 27 tracked translations render Ruth 1:1's setting identically as 'in the days when the judges ruled' or a very close equivalent; no translation differences bear on this question, which is a matter of unresolved historical dating, not wording.

**Reconciliation:** The book itself does not supply enough specific detail to fix a precise date, and scholars have proposed dates ranging across nearly the entire judges period based on inference from the genealogy (favoring a later date, closer to the end of the period, to minimize the number of generations that must be telescoped) or from the story's own internally stable, peaceful social conditions (which some read as favoring a date during one of the judges period's 'rest' intervals rather than an active oppression period, though this is a weaker and more subjective form of evidence). This entry is included not because a contradiction exists, but to note honestly that the text's own vagueness on this point means the severity of the chronology question in entry 4 above cannot be fully resolved by dating Ruth's setting more precisely -- both a late-judges and an early/mid-judges dating remain live scholarly positions.
