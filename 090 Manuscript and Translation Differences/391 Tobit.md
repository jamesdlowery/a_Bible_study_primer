...
## Tobit 6:2 — does the dog appear here, or only later in the story?

**The variant:** Tobit exists in a shorter ancient Greek edition ("Greek I," preserved in Codex Vaticanus and Alexandrinus) and a longer one ("Greek II," preserved in Codex Sinaiticus, about 1,700 words longer overall). RSV2CE's Tobit carries over the 1957 RSV Apocrypha translation, based on the shorter Greek I text. Most translations published since the 1960s — after Dead Sea Scrolls fragments confirmed the longer Greek II text is actually closer to the original Aramaic/Hebrew composition — switched to Greek II, including NABRE.
...
- **Douay-Rheims**, translated from the Vulgate (itself based on a now-lost Aramaic text Jerome worked from in a single night), also mentions the dog going with Tobias, though the Vulgate's wording and surrounding detail differ further from both Greek editions. **The Catholic Public Domain Version is confirmed directly following Douay-Rheims into this same camp**: its own text at verse 1 (CPDV numbers this material slightly differently than the Greek-based editions) reads "And so Tobias continued on, and the dog was following him, and he stayed at the first stopping point, near the river Tigris" -- confirming the dog's mention, with the Vulgate's characteristic departures from both Greek editions.
