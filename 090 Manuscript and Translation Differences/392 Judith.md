...
## Judith 2:17 (Douay-Rheims) / 2:27 (RSV2CE, NABRE) — a scene of destruction, told with different specifics

**The variant:** No Hebrew or Aramaic manuscript of Judith has ever been found — it survives only in Greek and in Jerome's Latin translation, which he explicitly says he made from a now-lost Aramaic text, working "sense for sense" in about a single night rather than word-for-word. The result is a Vulgate text about one-fifth shorter than the Greek overall, and different from it in specific narrated details, not just length. (Note the verse numbers themselves shift between the two traditions — this passage is 2:27 in the Greek-based numbering RSV2CE and NABRE use, and 2:17 in the Vulgate-based numbering Douay-Rheims uses.)
