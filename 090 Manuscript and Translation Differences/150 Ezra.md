# Ezra: Significant Textual Variants Across Ten Translations

**Translations covered:** AMP, CSB, ESV, KJV, NKJV, NASB, LSB, NIV, NLT, RSV2CE

A systematic search did not find a case in Ezra where the ten tracked translations render a verse with different, meaning-changing wording. The one well-known puzzle in this book is an internal arithmetic discrepancy in the underlying Hebrew text itself, not a translation difference -- every one of the ten tracked translations renders the numbers exactly as the Hebrew states them.
